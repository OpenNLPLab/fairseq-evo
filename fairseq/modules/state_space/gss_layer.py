...
########################################################################
# GSS
class GSSEncoderLayer(nn.Module):
    ...
    def build_self_attention(self, embed_dim, args):
        return GSSModule(
            ...
            # add
            dim_expansion_factor=getattr(args, "dim_expansion_factor", 4),
            dss_kernel_N=getattr(args, "dss_kernel_N", 512),
...
class GSSDecoderLayer(nn.Module):
    """Decoder layer block.
