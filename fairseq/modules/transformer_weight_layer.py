...
# merge attention
from fairseq.modules import MultiheadWeightAttention

# class WeightFormerEncoderLayer(TransformerEncoderLayer):
...
class WeightFormerEncoderLayer(nn.Module):
    def __init__(self, args):
        super().__init__()
        self.args = args
...
class WeightFormerDecoderLayer(nn.Module):
    """Decoder layer block.
