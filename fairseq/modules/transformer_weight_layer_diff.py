...
# merge attention
from fairseq.modules import MultiheadWeightAttention_diff

class WeightFormerEncoderLayer_diff(TransformerEncoderLayer):
    def __init__(self, args):
        super().__init__(args)

    def build_self_attention(self, embed_dim, args):
        return MultiheadWeightAttention_diff(
            embed_dim,
...
class WeightFormerDecoderLayer_diff(TransformerDecoderLayer):
    def __init__(
    ...
    def build_encoder_attention(self, embed_dim, args):
        return MultiheadCosformerAttention_diff(
            embed_dim,
            args.decoder_attention_heads,
