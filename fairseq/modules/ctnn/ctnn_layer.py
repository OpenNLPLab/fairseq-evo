...
from .gctu_module import GctuModule

class CtnnEncoderLayer(nn.Module):
...
class CtnnDecoderLayer(nn.Module):
    def __init__(
        ...
        # adaptive coef
        self.use_ada_coef = getattr(args, 'use_ada_coef', False)
        logging_info(f"use_ada_coef: {self.use_ada_coef}")
