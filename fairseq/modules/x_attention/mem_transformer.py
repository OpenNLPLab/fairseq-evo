...
from ..xl_utils import (LogUniformSampler, ProjectedAdaptiveLogSoftmax,
                        sample_logits)
...
class RelMultiHeadAttn(nn.Module):
    def __init__(self, n_head, d_model, d_head, dropout, dropatt=0,
                 tgt_len=None, ext_len=None, mem_len=None, pre_lnorm=False, use_linear=False):
...
class RelPartialLearnableLinearAttn(RelMultiHeadAttn):
    def __init__(self, *args, **kwargs):
        super(RelPartialLearnableLinearAttn, self).__init__(*args, **kwargs)

        self.r_net = nn.Linear(self.d_model, self.n_head * self.d_head, bias=False)
        self.act = get_activation_fn("1+elu")
...
class RelPartialLearnableDecoderLayer(nn.Module):
    def __init__(self, n_head, d_model, d_head, d_inner, dropout,
        ...
        if use_linear:
            ...
            mha = RelPartialLearnableMultiHeadAttn
        
        self.dec_attn = mha(n_head, d_model,
...
class MemTransformerLM(nn.Module):
    def __init__(self, n_token, n_layer, n_head, d_model, d_head, d_inner,
                 ...
                 sample_softmax=-1, use_ada=True, use_linear=False):
            ...
            for i in range(n_layer):
                self.layers.append(
                    RelPartialLearnableDecoderLayer(
                        ...
                        dropatt=dropatt, pre_lnorm=pre_lnorm, use_linear=use_linear)
                )
