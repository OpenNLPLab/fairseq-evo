...
from fairseq.modules.ffn import GLU
from fairseq.modules.helpers import get_norm_fn, logging_info
from fairseq.modules.norm import GatedRMSNorm, RMSNorm, SimpleRMSNorm
from .hgru_module import HgruModule


class HgrnEncoderLayer(nn.Module):
