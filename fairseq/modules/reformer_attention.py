...
# add
# import fast_transformers.attention.ReformerAttention as Refatt
from fast_transformers.attention import ReformerAttention
...
class ReformerAttention_(nn.Module):
    ...
    def __init__(
        ...
        self.inner_attention = ReformerAttention(chunk_size, bits, rounds, masked, 
                                                 softmax_temp, attention_dropout, event_dispatcher)
