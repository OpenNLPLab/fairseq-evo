...
# merge attention
from fairseq.modules import MultiheadCosformerAttention_

class CosformerEncoderLayer_(TransformerEncoderLayer):
    ...
    def build_self_attention(self, embed_dim, args):
        return MultiheadCosformerAttention_(
            ...
            drop_out=getattr(args, "drop_out", False),
            p=getattr(args, "p", 1.0)
        )

class CosformerDecoderLayer_(TransformerDecoderLayer):
    def __init__(
