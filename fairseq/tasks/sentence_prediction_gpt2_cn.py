...
@register_task("sentence_prediction_gpt2_cn")
class SentencePredictionGPT2CNTask(LegacyFairseqTask):
    """
    ...
    def load_dictionary(cls, args, filename, source=True):
        ...
        if 'label' in filename:
            ...
            dictionary = DictionaryGPT2_CN.load(filename)
        return dictionary
    ...
    def setup_task(cls, args, **kwargs):
        ...
        data_dict = cls.load_dictionary(
            args,
            os.path.join(args.data, "input0", "encoder.json"),
            source=True,
        )
