...
@dataclass
class LanguageModelingGPT2CNConfig(FairseqDataclass):
...
@register_task("lm_gpt2_cn", dataclass=LanguageModelingGPT2CNConfig)
class LanguageModelingTaskGPT2_CN(LegacyFairseqTask):
    """
    ...
    def setup_dictionary(cls, args, **kwargs):
        ...
        if args.data:
            ...
            assert len(paths) > 0
            dictionary = DictionaryGPT2_CN.load(os.path.join(paths[0], "encoder.json"))
