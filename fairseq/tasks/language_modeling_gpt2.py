...
@dataclass
class LanguageModelingGPT2Config(FairseqDataclass):
...
@register_task("lm_gpt2", dataclass=LanguageModelingGPT2Config)
class LanguageModelingTaskGPT2(LegacyFairseqTask):
    """
    ...
    def setup_dictionary(cls, args, **kwargs):
        ...
        if args.data:
            ...
            assert len(paths) > 0
            dictionary = DictionaryGPT2.load(os.path.join(paths[0], "encoder.json"))
