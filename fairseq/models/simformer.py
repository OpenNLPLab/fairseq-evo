...
class SimformerEncoder(FairseqEncoder):
    ...
    def __init__(self, args, dictionary, embed_tokens):
        ...
        index = 0
        d = 4
        n = args.encoder_layers // d
        m = args.encoder_layers % d
        arr = []
        for i in range(n):
            for j in range(d):
...
class TransformerMixEncoder(FairseqEncoder):
    """
    Transformer encoder consisting of *args.encoder_layers* layers. Each layer
    is a :class:`TransformerEncoderLayer`.
    ...
    def __init__(self, args, dictionary, embed_tokens):
        ...
        for i in range(n, args.encoder_layers):
            args.index = index#getattr(args, "index", index)
            arr.append(self.build_merge_encoder_layer(args))
            index += 1
    ...
    def build_merge_encoder_layer(self, args):
