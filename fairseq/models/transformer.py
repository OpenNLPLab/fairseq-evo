...
from fairseq.modules import (
    ...
    # weight different head
    WeightFormerDecoderLayer_diff,
    WeightFormerEncoderLayer_diff,
    # FLASH
    FlashEncoderLayer,
    FlashDecoderLayer,
    # FLASHLINEAR
...
# add rfa
class TransformerRfaDecoder(TransformerDecoder):
    def __init__(
        self,
        args,
        dictionary,
...
# debug
class TransformerRfaDebugDecoder(TransformerDecoder):
    def __init__(
        self,
        args,
        dictionary,
    ...
    def build_decoder_layer(self, args, no_encoder_attn=False):
        layer = TransformerRfaDecoderDebugLayer(args, no_encoder_attn)
        checkpoint = getattr(args, "checkpoint_activations", False)
        if checkpoint:
            offload_to_cpu = getattr(args, "offload_activations", False)
            layer = checkpoint_wrapper(layer, offload_to_cpu=offload_to_cpu)
...
# add reformer 
class ReformerDecoder(TransformerDecoder):
    def __init__(
        self,
        args,
        dictionary,
    ...
    def build_decoder_layer(self, args, no_encoder_attn=False):
        layer = ReformerDecoderLayer(args, no_encoder_attn)
        checkpoint = getattr(args, "checkpoint_activations", False)
        if checkpoint:
            offload_to_cpu = getattr(args, "offload_activations", False)
            layer = checkpoint_wrapper(layer, offload_to_cpu=offload_to_cpu)
...
class ReformerEncoder(TransformerEncoder):
    """
    Transformer encoder consisting of *args.encoder_layers* layers. Each layer
    is a :class:`TransformerEncoderLayer`.
    ...
    def build_encoder_layer(self, args):
        layer = ReformerEncoderLayer(args)
        checkpoint = getattr(args, "checkpoint_activations", False)
        if checkpoint:
            offload_to_cpu = getattr(args, "offload_activations", False)
            layer = checkpoint_wrapper(layer, offload_to_cpu=offload_to_cpu)
...
class TransformerSimpleDecoder(TransformerDecoder):
    def __init__(
        self,
        args,
        dictionary,
    ...
    def build_decoder_layer(self, args, no_encoder_attn=False):
        layer = TransformerSimpleDecoderLayer(args, no_encoder_attn)
        checkpoint = getattr(args, "checkpoint_activations", False)
        if checkpoint:
            offload_to_cpu = getattr(args, "offload_activations", False)
            layer = checkpoint_wrapper(layer, offload_to_cpu=offload_to_cpu)
...
class TransformerSimpleEncoder(TransformerEncoder):
    """
    Transformer encoder consisting of *args.encoder_layers* layers. Each layer
    is a :class:`TransformerEncoderLayer`.
    ...
    def build_encoder_layer(self, args):
        layer = TransformerSimpleEncoderLayer(args)
        checkpoint = getattr(args, "checkpoint_activations", False)
        if checkpoint:
            offload_to_cpu = getattr(args, "offload_activations", False)
            layer = checkpoint_wrapper(layer, offload_to_cpu=offload_to_cpu)
...
@register_model("transformersimple")
class TransformerSimpleModel(TransformerModel):
    """
    Transformer model from `"Attention Is All You Need" (Vaswani, et al, 2017)
    <https://arxiv.org/abs/1706.03762>`_.
    ...
    @classmethod
    def build_encoder(cls, args, src_dict, embed_tokens):
        return TransformerSimpleEncoder(args, src_dict, embed_tokens)
...
class TransformerHeadDecoder(TransformerDecoder):
    ...
    def build_decoder_layer(self, args, no_encoder_attn=False):
        layer = TransformerDecoderLayer_(args, no_encoder_attn)
        checkpoint = getattr(args, "checkpoint_activations", False)
        if checkpoint:
            offload_to_cpu = getattr(args, "offload_activations", False)
            layer = checkpoint_wrapper(layer, offload_to_cpu=offload_to_cpu)
...
class TransformerHeadEncoder(TransformerEncoder):
    """
    Transformer encoder consisting of *args.encoder_layers* layers. Each layer
    is a :class:`TransformerEncoderLayer`.
    ...
    def build_encoder_layer(self, args):
        layer = TransformerEncoderLayer_(args)
        checkpoint = getattr(args, "checkpoint_activations", False)
        if checkpoint:
            offload_to_cpu = getattr(args, "offload_activations", False)
            layer = checkpoint_wrapper(layer, offload_to_cpu=offload_to_cpu)
...
class TransformerTaylorDecoder(TransformerDecoder):
    ...
    def build_decoder_layer(self, args, no_encoder_attn=False):
        layer = TransformerTaylorDecoderLayer(args, no_encoder_attn)
        checkpoint = getattr(args, "checkpoint_activations", False)
        if checkpoint:
            offload_to_cpu = getattr(args, "offload_activations", False)
            layer = checkpoint_wrapper(layer, offload_to_cpu=offload_to_cpu)
...
class TransformerTaylorEncoder(TransformerEncoder):
    """
    Transformer encoder consisting of *args.encoder_layers* layers. Each layer
    is a :class:`TransformerEncoderLayer`.
    ...
    def build_encoder_layer(self, args):
        layer = TransformerTaylorEncoderLayer(args)
        checkpoint = getattr(args, "checkpoint_activations", False)
        if checkpoint:
            offload_to_cpu = getattr(args, "offload_activations", False)
            layer = checkpoint_wrapper(layer, offload_to_cpu=offload_to_cpu)
...
# multi splu
class TransformerSpluDecoder(TransformerDecoder):
    def __init__(
        self,
        args,
        dictionary,
    ...
    def build_decoder_layer(self, args, no_encoder_attn=False):
        layer = TransformerSpluDecoderLayer(args, no_encoder_attn)
        checkpoint = getattr(args, "checkpoint_activations", False)
        if checkpoint:
            offload_to_cpu = getattr(args, "offload_activations", False)
            layer = checkpoint_wrapper(layer, offload_to_cpu=offload_to_cpu)
...
class TransformerSpluEncoder(TransformerEncoder):
    ...
    def build_encoder_layer(self, args):
        layer = TransformerSpluEncoderLayer(args)
        checkpoint = getattr(args, "checkpoint_activations", False)
        if checkpoint:
            offload_to_cpu = getattr(args, "offload_activations", False)
            layer = checkpoint_wrapper(layer, offload_to_cpu=offload_to_cpu)
...
@register_model("transformertaylor")
class TransformerTaylorModel(TransformerModel):
    """
    Transformer model from `"Attention Is All You Need" (Vaswani, et al, 2017)
    <https://arxiv.org/abs/1706.03762>`_.
    ...
    @classmethod
    def build_encoder(cls, args, src_dict, embed_tokens):
        return TransformerTaylorEncoder(args, src_dict, embed_tokens)
...
@register_model("decoder_transformertaylor")
class Decoder_TransformerTaylorModel(TransformerModel):
    """
    Transformer model from `"Attention Is All You Need" (Vaswani, et al, 2017)
    <https://arxiv.org/abs/1706.03762>`_.
...
@register_model("encoder_transformertaylor")
class TransformerTaylorModel(TransformerModel):
    """
    Transformer model from `"Attention Is All You Need" (Vaswani, et al, 2017)
    <https://arxiv.org/abs/1706.03762>`_.
...
# add weight former different head

class WeightFormerEncoder_diff(FairseqEncoder):
    """
    Transformer encoder consisting of *args.encoder_layers* layers. Each layer
    is a :class:`TransformerEncoderLayer`.
    ...
    def __init__(self, args, dictionary, embed_tokens):
        ...
        for i in range(args.encoder_layers):
            args.index = i
            args.encoder_attention_heads = args.all_heads[i]
            # args.index = getattr(args, "index", _)
            arr.append(self.build_encoder_layer(args))
        self.layers.extend(arr)
        # self.layers.extend(
    ...
    def build_encoder_layer(self, args):
        layer = WeightFormerEncoderLayer_diff(args)
        checkpoint = getattr(args, "checkpoint_activations", False)
        if checkpoint:
            offload_to_cpu = getattr(args, "offload_activations", False)
            layer = checkpoint_wrapper(layer, offload_to_cpu=offload_to_cpu)
...
class WeightFormerDecoder_diff(FairseqIncrementalDecoder):
    """
    Transformer decoder consisting of *args.decoder_layers* layers. Each layer
    is a :class:`TransformerDecoderLayer`.
    ...
    def __init__(
        ...
        for i in range(args.decoder_layers):
            args.index = i
            args.decoder_attention_heads = args.all_heads[i]
            # args.index = getattr(args, "index", _)
            arr.append(self.build_decoder_layer(args, no_encoder_attn))
        self.layers.extend(arr)
    ...
    def build_decoder_layer(self, args, no_encoder_attn=False):
        layer = WeightFormerDecoderLayer_diff(args, no_encoder_attn)
        checkpoint = getattr(args, "checkpoint_activations", False)
        if checkpoint:
            offload_to_cpu = getattr(args, "offload_activations", False)
            layer = checkpoint_wrapper(layer, offload_to_cpu=offload_to_cpu)
...
#######################
class FlashEncoder(TransformerEncoder):
    """
    Transformer encoder consisting of *args.encoder_layers* layers. Each layer
    is a :class:`TransformerEncoderLayer`.
...
class FlashDecoder(TransformerDecoder):
    def __init__(
        self,
        args,
        dictionary,
    ...
    def build_decoder_layer(self, args, no_encoder_attn=False):
        layer = FlashDecoderLayer(args, no_encoder_attn)
        checkpoint = getattr(args, "checkpoint_activations", False)
        if checkpoint:
            offload_to_cpu = getattr(args, "offload_activations", False)
            layer = checkpoint_wrapper(layer, offload_to_cpu=offload_to_cpu)
...
class FlashModel(TransformerModel):
    ...
    @classmethod
    def build_encoder(cls, args, src_dict, embed_tokens):
        return FlashEncoder(args, src_dict, embed_tokens)
...
class MemEncoder(TransformerEncoder):
    """
    Transformer encoder consisting of *args.encoder_layers* layers. Each layer
    is a :class:`TransformerEncoderLayer`.
...
class MemDecoder(TransformerDecoder):
    def __init__(
        self,
        args,
        dictionary,
    ...
    def build_decoder_layer(self, args, no_encoder_attn=False):
        layer = MemDecoderLayer(args, no_encoder_attn)
        checkpoint = getattr(args, "checkpoint_activations", False)
        if checkpoint:
            offload_to_cpu = getattr(args, "offload_activations", False)
            layer = checkpoint_wrapper(layer, offload_to_cpu=offload_to_cpu)
...
class MemGauEncoder(TransformerEncoder):
    """
    Transformer encoder consisting of *args.encoder_layers* layers. Each layer
    is a :class:`TransformerEncoderLayer`.
...
class MemGauDecoder(TransformerDecoder):
    def __init__(
        self,
        args,
        dictionary,
    ...
    def build_decoder_layer(self, args, no_encoder_attn=False):
        layer = MemGauDecoderLayer(args, no_encoder_attn)
        checkpoint = getattr(args, "checkpoint_activations", False)
        if checkpoint:
            offload_to_cpu = getattr(args, "offload_activations", False)
            layer = checkpoint_wrapper(layer, offload_to_cpu=offload_to_cpu)
...
@register_model("MemGau_model")
class MemGauModel(TransformerModel):
    """
    Transformer model from `"Attention Is All You Need" (Vaswani, et al, 2017)
    <https://arxiv.org/abs/1706.03762>`_.
    ...
    @classmethod
    def build_encoder(cls, args, src_dict, embed_tokens):
        return MemGauEncoder(args, src_dict, embed_tokens)

    @classmethod
    def build_decoder(cls, args, tgt_dict, embed_tokens):
        return MemGauDecoder(
            args,
            tgt_dict,
            embed_tokens,
            no_encoder_attn=getattr(args, "no_cross_attention", False),
...
############### GMU
class GmuEncoder(TransformerEncoder):
    """
    Transformer encoder consisting of *args.encoder_layers* layers. Each layer
    is a :class:`TransformerEncoderLayer`.
...
class GmuDecoder(TransformerDecoder):
    def __init__(
        self,
        args,
        dictionary,
    ...
    def build_decoder_layer(self, args, no_encoder_attn=False):
        layer = GmuDecoderLayer(args, no_encoder_attn)
        checkpoint = getattr(args, "checkpoint_activations", False)
        if checkpoint:
            offload_to_cpu = getattr(args, "offload_activations", False)
            layer = checkpoint_wrapper(layer, offload_to_cpu=offload_to_cpu)
...
############### Linear Kernel attention with orpe
...
class LSAttentionDecoder(TransformerDecoder):
    def __init__(
        self,
        args,
        dictionary,
    ...
    def build_decoder_layer(self, args, no_encoder_attn=False):
        layer = LSAttentionDecoderLayer(args, no_encoder_attn)
        checkpoint = getattr(args, "checkpoint_activations", False)
        if checkpoint:
            offload_to_cpu = getattr(args, "offload_activations", False)
            layer = checkpoint_wrapper(layer, offload_to_cpu=offload_to_cpu)
...
##################### LinearVanilla
class LinearVanillaAttentionEncoder(TransformerEncoder):
    """
    Transformer encoder consisting of *args.encoder_layers* layers. Each layer
    is a :class:`TransformerEncoderLayer`.
...
# cosformer
# parameters used in the "Attention Is All You Need" paper (Vaswani et al., 2017)
@register_model_architecture("transformertaylor", "cosformer_vaswani_wmt_en_de_big")
...
@register_model_architecture("decoder_cosformer", "decoder_cosformer_wmt_en_de_small")
def cosformer_wmt_en_de_small(args):
    base_architecture(args)
    args.use_relu = getattr(args, "use_relu", True)
    args.max_l = getattr(args, "max_l", 4400)
...
@register_model_architecture("decoder_transformertaylor", "decoder_relu_vaswani_wmt_en_de_small")
def cosformer_vaswani_wmt_en_de_big(args):
    base_architecture(args)
    args.use_relu = getattr(args, "use_relu", True)
    args.norm_taylor = getattr(args, "norm_taylor", False)

@register_model_architecture("decoder_transformertaylor", "decoder_linear_vaswani_wmt_en_de_small")
def cosformer_vaswani_wmt_en_de_big(args):
    base_architecture(args)
    args.do_scale = getattr(args, "do_scale", False)
    args.use_linear = getattr(args, "use_linear", True)
...
@register_model_architecture("encoder_cosformer", "encoder_cosformer_multi_wmt_en_de_small")
def cosformer_wmt_en_de_small(args):
    base_architecture(args)
    args.use_relu = getattr(args, "use_relu", True)
    args.max_l = getattr(args, "max_l", 4400)
...
@register_model_architecture("encoder_cosformer", "encoder_cosformer_wmt_en_de_small_without")
def cosformer_wmt_en_de_small(args):
    base_architecture(args)
    args.use_relu = getattr(args, "use_relu", True)
...
# encoder relu + decoder softmax
@register_model_architecture("encoder_transformertaylor", "encoder_relu_vaswani_wmt_en_de_small")
def cosformer_vaswani_wmt_en_de_big(args):
    base_architecture(args)
    args.use_relu = getattr(args, "use_relu", True)
    args.norm_taylor = getattr(args, "norm_taylor", False)

# encoder linear + decoder softmax
@register_model_architecture("encoder_transformertaylor", "encoder_linear_vaswani_wmt_en_de_small")
def cosformer_vaswani_wmt_en_de_big(args):
    base_architecture(args)
    args.do_scale = getattr(args, "do_scale", False)
    args.use_linear = getattr(args, "use_linear", True)
