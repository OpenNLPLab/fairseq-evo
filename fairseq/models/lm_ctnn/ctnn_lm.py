...
# decay test
@register_model_architecture("ctnn_lm", "ctnn_lm_c0_h8_pre")
def ctnn_lm_c0_h8_pre(args):
    base_lm_architecture(args)
    args.decoder_normalize_before = True
    args.decoder_layers = 6
    # pos
...
@register_model_architecture("ctnn_lm", "ctnn_lm_c0_22_h8_pre")
def ctnn_lm_c0_22_h8_pre(args):
    base_lm_architecture(args)
    args.decoder_normalize_before = True
    args.decoder_layers = 6
    # pos
...
# sine
@register_model_architecture("ctnn_lm", "ctnn_lm_pre_sine_wn")
def ctnn_lm_pre_sine_wn(args):
    base_lm_architecture(args)
    args.decoder_normalize_before = True
    # model
    args.decoder_attention_heads = 1
...
@register_model_architecture("ctnn_lm", "ctnn_lm_22_pre_sine_wn")
def ctnn_lm_22_pre_sine_wn(args):
    base_lm_architecture(args)
    args.decoder_normalize_before = True
    # model
    args.decoder_attention_heads = 1
