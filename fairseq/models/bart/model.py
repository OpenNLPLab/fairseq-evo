...
from fairseq.models.transformer import TransformerModel, TransformerMergeModel
...
# merge
@register_model("bartmerge")
class BARTMergeModel(TransformerMergeModel):
    __jit_unused_properties__ = ["supported_targets"]
...
# merge
@register_model_architecture("bartmerge", "bart_merge_base")
def bart_merge_base_architecture(args):
    args.encoder_embed_dim = getattr(args, "encoder_embed_dim", 768)
    args.encoder_ffn_embed_dim = getattr(args, "encoder_ffn_embed_dim", 4 * 768)
    args.encoder_layers = getattr(args, "encoder_layers", 6)
    args.encoder_attention_heads = getattr(args, "encoder_attention_heads", 12)
