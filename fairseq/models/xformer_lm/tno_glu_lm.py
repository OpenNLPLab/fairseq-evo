...
@register_model_architecture("tno_glu_lm", "tno_glu_silu_simplermsnorm_toep_no_use_exp_1_rate_4_glu_1_dpb_v4_no_norm_no_pos_forward1_shrink4_large_one_head")
def tno_glu_silu_simplermsnorm_toep_no_use_exp_1_rate_4_glu_1_dpb_v4_no_norm_no_pos_forward1_shrink4_large_one_head(args):
    base_lm_architecture(args)
    args.act_fun = "silu"
    args.causal = True
    # norm
