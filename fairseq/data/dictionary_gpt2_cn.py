...
DEFAULT_VOCAB = os.path.dirname(current_path)+'/encoders/gpt2_tokenizer_cn/vocab.vocab'
DEFAULT_VOCAB_MODEL = os.path.dirname(current_path)+'/encoders/gpt2_tokenizer_cn/vocab.model'
class DictionaryGPT2_CN:
    ...
    def add_from_file(self, f):
        ...
        if isinstance(f, str):
            try:
                self.bpe = GPT2BPE_CN()
                with open(DEFAULT_VOCAB, "r", encoding="utf-8") as fd:
...
class GPT2BPE_CN(object):
    ...
    def __init__(self):
        ...
        self.sp = spm.SentencePieceProcessor(model_file=DEFAULT_VOCAB_MODEL)
